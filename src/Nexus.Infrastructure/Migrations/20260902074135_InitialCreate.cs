        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContextEntityId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AiConversations_Workspaces_WorkspaceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MasteryLevel = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KnowledgeConcepts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_KnowledgeConcepts_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MindMaps_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quizzes_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudySessions_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartCharOffset = table.Column<int>(type: "int", nullable: false),
                    EndCharOffset = table.Column<int>(type: "int", nullable: false),
                    PageNumber = table.Column<int>(type: "int", nullable: false),
                    VectorStoreId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextReviewDateUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Flashcards_KnowledgeConcepts_ConceptId",
                        column: x => x.ConceptId,
                        principalTable: "KnowledgeConcepts",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KnowledgeRelations_KnowledgeConcepts_SourceConceptId",
                        column: x => x.SourceConceptId,
                        principalTable: "KnowledgeConcepts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_KnowledgeRelations_KnowledgeConcepts_TargetConceptId",
                        column: x => x.TargetConceptId,
                        principalTable: "KnowledgeConcepts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_KnowledgeRelations_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceTitle = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SourceReferences_AiMessages_AiMessageId",
                        column: x => x.AiMessageId,
                        principalTable: "AiMessages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SourceReferences_DocumentChunks_DocumentChunkId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KnowledgeConcepts_WorkspaceId_NormalizedName",
                table: "KnowledgeConcepts",
                columns: new[] { "WorkspaceId", "NormalizedName" });

            migrationBuilder.CreateIndex(
                name: "IX_KnowledgeRelations_SourceConceptId",
                table: "KnowledgeRelations",
                column: "SourceConceptId");

            migrationBuilder.CreateIndex(
                name: "IX_KnowledgeRelations_TargetConceptId",
                table: "KnowledgeRelations",
                column: "TargetConceptId");

            migrationBuilder.CreateIndex(
                name: "IX_KnowledgeRelations_WorkspaceId_SourceConceptId_TargetConceptId",
                table: "KnowledgeRelations",
                columns: new[] { "WorkspaceId", "SourceConceptId", "TargetConceptId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SourceReferences_AiMessageId",
                table: "SourceReferences",
                column: "AiMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_SourceReferences_DocumentChunkId",
                table: "SourceReferences",
